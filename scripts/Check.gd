...
const TITLE := "V3.2 CHECK LIST"

const ITEMS := [
	{"t": "JAPANESE FONT", "d": "TITLE BOTTOM LEFT SHOWS FONT NAME. IF NONE, ALL TEXT STAYS ENGLISH."},
	{"t": "JAPANESE TEXT", "d": "TITLE, TALK, PREP AND BATTLE UI SHOW JAPANESE WHEN FONT IS FOUND."},
	{"t": "BGM", "d": "TITLE, BATTLE, WIN AND LOSE HAVE DIFFERENT LOOPS."},
	{"t": "SOUND EFFECTS", "d": "SELECT, SLASH, HIT, HEAL, DOWN AND LEVEL UP ALL SOUND."},
	{"t": "SOUND TOGGLE", "d": "TITLE HAS A SOUND ON OFF BUTTON. OFF STOPS EVERYTHING."},
	...
	{"t": "MAP 2 BRIDGES", "d": "THREE ROAD CROSSINGS OVER THE RIVER. BOTH SIDES CAN MEET."},
	{"t": "NO CUT OFF WARNING", "d": "TOP BAR MUST NOT SHOW MAP WARNING ON ANY MAP."},
