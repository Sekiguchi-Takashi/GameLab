...
func _draw() -> void:
	...
	Gfx.text(self, "ART %d EXTERNAL" % Gfx.ext_count, Vector2(6.0, 346.0), Pal.c("dgray"))
	Gfx.draw_unit(self, "KNIGHT0", false, Rect2(96.0, 150.0, 96.0, 96.0), Color(1, 1, 1, 1))
	Gfx.draw_unit(self, "ORC0", true, Rect2(452.0, 150.0, 96.0, 96.0), Color(1, 1, 1, 1))
	var l := _labels()
	for i in l.size():
		var b := _btn(i)
